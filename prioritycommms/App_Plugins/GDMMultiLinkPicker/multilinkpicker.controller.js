...
*/ 
function multiLinkPickerController($scope, angularHelper, localizationService, entityResource, iconHelper, editorService) {
    var vm = {
        labels: {
            general_recycleBin: ""
        }
...
angular.module("umbraco").controller("GDM.MultiLinkPickerController", multiLinkPickerController);
