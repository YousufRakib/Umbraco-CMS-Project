/*
 * RM: 27 Sep 2019
 * This is the code from Umbraco src/views/propertyeditors/multiurlpicker/multiurlpicker.js
 * With $scope.model.value being set each time $scope.renderModel is set and controller name changed to GDM.MultiLinkPickerController
 * This is due to when testing $scope.$on("formSubmitting"... did not fire
 * And due to inability to use in a Macro
*/ 
function gdmSingleLinkPickerController($scope, angularHelper, localizationService, entityResource, iconHelper, editorService) {
...
angular.module("umbraco").controller("GDM.SingleLinkPickerController", gdmSingleLinkPickerController);
